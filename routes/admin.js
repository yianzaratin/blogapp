...
router.post("/categorias/nova", (req, res) => {
    ...
    if (erros.lenght > 0 ){
        ...
        new Categoria (novaCategoria).save().then(() => {
            ...
            req.flash ('error.msg', 'Houve um erro ao salvar a categoria, tente novamente! ' +err)
            res.redirect("/admin/categorias")
        })
...
router.get('/postagens/add', (req, res)=>{
    Categoria.find().sort({name: 'asc'}).lean(true).then((categoria)=>{
        ...
        console.log('Erro ao carregar formulário, '+erro)
        res.redirect('/admin')
    })
...
router.post ("/postagens/nova", (req, res) =>{
    ...
    if (req.body.categoria == "0"){
        ...
        new Postagem (novaPostagem).save().then(() => {
            ...
            req.flash ('error_msg', 'Houve um durante o salvamento da postagem' +err)
            res.redirect("/admin/postagens")
        })
    }
})
